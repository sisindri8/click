...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleTranscriptFetchException(TranscriptFetchException ex) {
        log.error("Transcript fetch failed: {}", ex.getMessage());
        return ResponseEntity
                .status(HttpStatus.UNPROCESSABLE_ENTITY)
                .body(errorBody("TRANSCRIPT_FETCH_FAILED", ex.getMessage()));
    }
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(Exception ex) {
        log.error("Unexpected error in Transcript Service", ex);
        return ResponseEntity
